...
## 2. Proactive Token Validation via `/users/me`
...
## 3. axios with Interceptors for Auto-Token
...
## 5. Zod as Single Source of Truth (No Duplicate Types)
...
## 6. `schemas/` Instead of `validations/`
...
## 7. TanStack React Query for Server State
...
## 8. shadcn/ui (Not Pure Tailwind, Not Headless UI)
